...
var centerY = window.Height / 2 - svgIconH / 2;
// 获取当前播放状态
...
function on_paint(gr) {
    ...
    gr.DrawImage(svgIconObj, 0, centerY, svgIconObj.Width, svgIconObj.Height, 0, 0, svgIconObj.Width, svgIconObj.Height);
}

function on_size() {
    centerY = window.Height / 2 - svgIconH / 2
}
