...
function _RGB(r, g, b) { return 0xff000000 | (r << 16) | (g << 8) | b; }
function _scale(size) { return Math.round((size * window.DPI) / 72); }
...
function on_paint(gr) {
    ...
    if (g_imgs.icon) {
        gr.DrawImage(
            ...
            layout.text_h,
            layout.text_h,
            0, 0, g_imgs.icon.Width, g_imgs.icon.Height
        );
    }
    ...
    if (g_imgs.chevron) {
        gr.DrawImage(
            ...
            layout.text_h,
            layout.text_h,
            0, 0, g_imgs.chevron.Width, g_imgs.chevron.Height
        );
    }
    ...
    if (current_btn_img) {
        gr.DrawImage(
            ...
            button.w,
            button.h,
            0, 0, current_btn_img.Width, current_btn_img.Height
        );
    }
}
